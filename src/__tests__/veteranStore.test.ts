...
const data: DashboardData = {
  veteran: { id: 'v1', name: 'Jordan Brooks', email: 'j@example.com', phone: '', branch: 'Navy', servicePeriod: '2012–2020', dischargeStatus: 'Honorable', location: 'Austin', preferredContact: 'Email' },
  benefits: [
    { id: 'b1', title: 'Education', category: 'Education', summary: '', description: '', status: 'approved', progress: 100, nextStep: '', saved: false },
    { id: 'b2', title: 'Health', category: 'Health', summary: '', description: '', status: 'eligible', progress: 0, nextStep: '', saved: true },
  ],
  actionItems: [
...
vi.mock('../repositories/dataRepository', () => ({ fetchDashboardData: vi.fn(async () => structuredClone(data)) }))
